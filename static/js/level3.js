function f5() {
  ...
  var text=document.getElementById("he").value;
          if(text==='Freddy Krueger' || text==='freddy krueger' || text==='FREDDY KRUGER'){
            //   var c=a.appendChild(document.createElement('img')).src = 'll.png';
    ...
    var d=document.getElementById("hint23");
      ...
      s();
              ...
              on.addEventListener('click',()=>{
                  ...
                  done.classList.remove("hin");
                  var b=document.getElementById("bt");
                  b.classList.remove("hin")
    var b=document.getElementById("he").value;
  
          if(b=='Mohali' ||b==='mohali' || b==='MOHALI'){
  ...
  //     s();
          ...
          function f12(){
            ...
            document.getElementById("time").value=`hour :${hour} minute:${minute} second:${second}`
